...
public class CalendarPage extends AbsBasePage {
    ...
    public CalendarPage checkStartDateEvent() {
        for(WebElement dateEvent: dateEvents) {
            ...
            LocalDate eventDate;
           //eventDate = LocalDate.parse(dateEventStr, DateTimeFormatter.ofPattern("dd MMMM yyyy", Locale.of("ru")));
            eventDate = LocalDate.parse(dateEventStr, DateTimeFormatter.ofPattern("dd MMMM yyyy"));
